...
// adapted version of
// https://github.com/jsuarezruiz/AvaloniaSkiaSharpFiddle/

namespace M64RPFWAvalonia.src.Controls
{
    public class SkiaCanvas : Control, ISkiaCanvasProvider
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void Draw(SKImage image, SKSizeI? size = null)
        {
            if (size != null)
            {
                this.DrawingSize = size.Value;
            }
            this.RasterDrawing = image;
            Invalidate();
        }
    }
}