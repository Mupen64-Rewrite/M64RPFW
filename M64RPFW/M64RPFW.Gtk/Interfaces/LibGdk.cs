...
public static class LibGdk
{
    internal const string LibName = "libgdk-3.so";
    ...
    public static bool IsX11Display(this Gdk.Display display)
    {
    ...
    public static bool IsWaylandDisplay(this Gdk.Display display)
    {
    ...
    public static IntPtr GetXDisplay(this Gdk.Display display)
    {
    ...
    public static X11.Window GetXID(this Gdk.Window window)
    {
    ...
    public static unsafe WlDisplay GetWlDisplay(this Gdk.Display display)
    {
    ...
    /// <summary>
    /// Returns the <see cref="WlSurface"/> corresponding to a <see cref="Gdk.Window"/>.
    /// </summary>
    /// <param name="window">a <see cref="Gdk.Window"/></param>
    /// <returns>A <see cref="WlSurface"/></returns>
    public static unsafe WlSurface GetWlSurface(this Gdk.Window window)
    {
