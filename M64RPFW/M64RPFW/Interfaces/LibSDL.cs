/* The enums used here derive from SDL2#.
 * Its license is provided here for your information.
 * 
...
namespace M64RPFW.Interfaces;

internal class LibSDL
{
    ...
    public enum SDL_InitFlags : uint
    {
        ...
        SDL_INIT_AUDIO = 0x0000_0002,
        SDL_INIT_VIDEO = 0x0000_0004,
        SDL_INIT_JOYSTICK = 0x0000_0008,
        SDL_INIT_HAPTIC = 0x0000_0010,
        SDL_INIT_GAMECONTROLLER = 0x0000_0020,
        SDL_INIT_EVENTS = 0x0000_0040,
        SDL_INIT_SENSOR = 0x0000_0080,
        SDL_INIT_NOPARACHUTE = 0x0010_0000,
        SDL_INIT_EVERYTHING = 0X0010_00FF
    }
    ...
    [DllImport(LibName)]
    public static extern SDL_Scancode SDL_GetScancodeFromKey(SDL_Keycode code);
}